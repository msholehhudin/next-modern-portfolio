    ...
    <div className="py-20" id="projects">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10 border border-yellow-400">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            className="border border-red-500 sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]"
            key={id}
          >
            <PinContainer title={link} href={link}>
              ...
              <p className="text-sm lg:text-xl lg:font-normal font-light line-clamp-3">
                {des}
              </p>
