  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(57,85,177,0.6306897759103641) 41%, rgba(0,212,255,1) 100%)",
      }}
    >
      {/* <div className={`${id === 6 && "border border-red-500"}`}>Test</div> */}
      {/* add img divs */}
            ...
            <div className="flex gap-1 w-fit absolute -right-3 lg:-right-2 lg:gap-5">
              <div className="flex flex-col gap-3 lg:gap-8">
                {leftLists.map((item) => (
                  <span
                    key={item}
                    className="py-3 lg:py-4 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 text-center rounded-lg bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
              ...
              <div className="flex flex-col gap-3 lg:gap-5">
                ...
                {rightList.map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 text-center rounded-lg bg-[#10132E]"
                  >
                    {item}
                  </span>
                ))}
